...
from App_Login.forms import CreateNewUser,EditPofile
...
def edit_profile(request):
    ...
    try:
        ...
        current_user = None
    form=EditPofile(instance=current_user)
    if request.method=="POST":
        form=EditPofile(request.POST,request.FILES,instance=current_user)
        if form.is_valid():
